  ...
  <div class="album py-5 bg-light">
    <div class="container">
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        <div class="col" v-for="item in attList" :key="item.houseCode">
          <div class="card shadow-sm">
            <img
              class="bd-placeholder-img card-img-top"
              width="100%"
              height="225"
              src="img/apartmentImage.png"
...
export default {
  ...
  methods: {
    ...
    ...mapActions(ApartInfo, ["subAttHouse"]),
    moveMap(e) {
